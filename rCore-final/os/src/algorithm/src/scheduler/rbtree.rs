...
use crate::scheduler::cfs_scheduler::{CFSThread,VrunCompare};
...
unsafe impl<ThreadType:Clone + Eq +core::marker::Send> core::marker::Send for RBTree<VrunCompare,CFSThread<ThreadType>>{}
